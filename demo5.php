...
$sub_presenters[]=array(  'video_mp4' => "demo/video-1798-4743-131-606c7879614d5.mp4",  'offset' => 1,  'length' => 15,);
$sub_presenters[]=array(  'video_mp4' => "demo/3.mp4",  'offset' => 4,  'length' => 15,);
$sub_presenters[]=array(  'video_mp4' => "demo/4.mp4",  'offset' => 3,  'length' => 15,);
$sub_presenters[]=array(  'video_mp4' => "demo/video-1798-4743-131-606c7879614d5.mp4",  'offset' => 2,  'length' => 15,);
// end of videos description


// do video part 1
$tmpOutput=$processing->getTemporaryFile("ts") ;
$videos[]=$tmpOutput;
$commands=$processing->prepareVideo($presenter, $sub_presenters, $tmpOutput) ;
...
$sub_presenters[]=array(  'video_mp4' => "demo/video-1798-4743-131-606c7879614d5.mp4",  'offset' => 5,  'length' => 12,);
$sub_presenters[]=array(  'video_mp4' => "demo/4.mp4",  'offset' => 25,  'length' => 20,);
$sub_presenters[]=array(  'video_mp4' => "demo/5.mp4",  'offset' => 33,  'length' => 20,);
...
$processing->removeTemporaryFiles();
